...
#define USB_CFG_CLOCK_KHZ       (F_CPU/1000) // F_CPU used is 16500000
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A', 'V', 'R', ' ', 'S', 't', 'i', 'c', 'k', ' ',  'T', 'e', 'm', 'p', 'e', 'r', 'a', 't', 'u', 'r', 'e', ' ',  'L', 'o', 'g', 'g', 'e', 'r'
...
#define USB_CFG_INTERFACE_SUBCLASS  1   /* yes, boot interface */
